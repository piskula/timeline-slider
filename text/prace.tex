...
Kybernetický polygón (KYPO) je uzavreté prostredie pre testovanie kybernetických útokov, ktoré bolo vybudované v roku 2015 vrámci rekonštrukcie Fakulty Informatiky. Toto prostredie funguje na princípe cloudového riešenia v ktorom je možné modelovať virtuálnu sieť\cite{eichler2014analytical}. Je určené pre výzkum a testovanie rôznych scenárov kybernetických útokov v izolovanom a plne kontrolovateľnom prostredí\cite{vceleda2015kypo}.
...
Liferay obsahuje veľké množstvo hotových portletov, avšak jeho hlavná výhoda tkvie v možnosti rozšíriť ponuku týchto portletov o svoje vlastné. Jednotlivé stránky obsahujúce portlety (pages) je potom možné zaraďovať do umiestnení (sites).
