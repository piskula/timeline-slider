...
Keďže niektoré stavy, ktoré si drží modul (stav zámkov, minima, maxima, zvoleného intervalu) sa môžu navzájom ovplyvňovať, implementoval som 10 jednotkových testov, ktoré pokrývajú väčšinu možných scenárov. Tieto udalosti môžu byť vyvolané buď príchodom nových dát (zmenou možného ohraničenia), alebo činnosťou užívateľa.

Vhodným pokračovaním tejto práce by bolo nasadenie portletu do produkčnej verzie Liferay portálu a intenzívne užívateľské testovanie, ktoré by mohlo odhaliť slabiny dizajnového riešenia. Takéto testovanie vie priniesť veľmi cenný pohľad koncového používateľa, ktoré ja v~pozícii vývojára nemusím postrehnúť. Za prínos by som určite považoval kontrolu mojej implementácie z hľadiska kvality kódu, nakoľko kód TypeScriptu je o dosť odlišný od programovacích jazykov široko využívaných vrámci fakulty.
