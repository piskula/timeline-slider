...
\thesissetup{
    ...
    title         = {Interaktivní časová osa jako modul v Angularu},
    %TeXtitle      = {The Proof of $\mathsf{P}=\mathsf{NP}$},
    TeXtitle      = {Interaktivní časová osa jako modul v Angularu},
...
Angular je open-source platforma od spoločnosti Google určená pre tvorbu front-end aplikácií. Využíva TypeScript ako odporúčaný programovací jazyk, ale je možné využiť aj JavaScript.
