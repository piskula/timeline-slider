 ...
 *  using this software commercially or in ways not allowed in aforementioned
...
<portlet:actionURL var="actionURL" name="savePreferencesURLAction" />

This is EDIT page of the portlet.
